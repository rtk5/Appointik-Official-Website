...
const walkthrough = [
  {
    ...
    features: ['Schedule multiple appointments', 'Auto increment time slots', 'SMS/WhatsApp reminders'],
    mockData: {
  ...
  },
  {
    ...
    description: 'Generate invoices, track payments, and manage multiple billing types',
    features: ['Dispensary billing', 'Clinic billing', 'Lab billing'],
    mockData: {
